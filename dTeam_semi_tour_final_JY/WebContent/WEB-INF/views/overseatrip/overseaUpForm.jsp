...
<div class="container">
<h3>국내여행등록</h3>
	<form action="overseaUpProcess" method="post" enctype="multipart/form-data" id="overseaupform">
		<div class="form-group">
			<label for="oarea">oarea</label> <input type="text" class="form-control"
				id="oarea" placeholder="oarea 입력" name="oarea">
		</div>
		<div class="form-group">
			<label for="ottitle">ottitle</label> <input type="text" class="form-control"
				id="ottitle" placeholder="ottitle 입력" name="ottitle">
		</div>
		<div class="form-group">
			<label for="ocontent">ocontent</label> <input type="text"
				class="form-control" id="ocontent" placeholder="ocontent 입력" name="ocontent">
		</div>
		<div class="row mb-3">
					...
					<div class="col-sm-10">
						<img id="imgx"
							src="${ctrpath}/resources/img/logo.png">
					</div>
				</div>
<!--  
		<div class="form-group">
	...
	-->	
		<div class="form-group">
			<label for="oprice">oprice</label> <input type="number" class="form-control"
				id="oprice" placeholder="oprice 입력" name="oprice"
				required="required">
		</div>
<!--		
		<div class="form-group">
...
-->	
		<input type="hidden" id="htcode" name="htcode" value="1"> 
